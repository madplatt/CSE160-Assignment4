...
class Vector3 {
    ...
    static dot(other1, other2) {
        // Insert your code here.
        var i, left, right, sum;

        left = other1.elements;
        right = other2.elements;
        sum = 0;
    ...
    static cross(other1, other2) {
        ...
        left = other1.elements;
        right = other2.elements;
        i = left[1] * right[2] - left[2] * right[1];
        j = left[2] * right[0] - left[0] * right[2]
        k = left[0] * right[1] - left[1] * right[0];
    ...
    magnitude() {
        // Insert your code here.
        var myVec = this.elements;
        let m = Math.sqrt(Math.pow(myVec[0],2) + Math.pow(myVec[1],2) + Math.pow(myVec[2],2)); // Modify this line to calculate this vector's magnitude.
